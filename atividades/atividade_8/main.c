...
// Pinos
#define LED_0       GPIO_NUM_9
#define LED_1       GPIO_NUM_8
#define LED_2       GPIO_NUM_3
#define LED_3       GPIO_NUM_14
#define BOTAO_MAIS  GPIO_NUM_4
#define BOTAO_MENOS GPIO_NUM_1
#define PINO_BUZZER GPIO_NUM_37
#define PINO_I2C_SDA GPIO_NUM_48
#define PINO_I2C_SCL GPIO_NUM_47
#define ADC_NTC     ADC1_CHANNEL_6
